...
<body>
    ...
    <div class="m1" id="d1">
        ...
        $sql = "SELECT student.Name, student.Roll_No, student.Reg_date, student.reg_id, branch.branch, semester.semester 
                ...
                WHERE student.Roll_No = $stid 
                  AND student.branch_id = $branch_id 
                  AND student.sem_id = $sem_id";
        ...
        ?>
            <table>
                ...
                <tbody>
        <?php
            $totalc = 0; // Initialize total marks
        ...
        ?>
            <div class="inr">
                ...
                <?php echo htmlentities("Invalid Roll Id"); ?>
            </div>
        <?php
        }
        ?>
